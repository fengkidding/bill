...
import com.bill.manager.download.factory.DownloadAdapterFactory;
import com.bill.manager.download.utils.CalculationUtils;
import com.bill.manager.download.utils.DownloadUtils;
...
public class DownloadServiceImpl implements DownloadService {
    ...
    public String downloadExcel(DownloadParamVmo downloadParamVmo) {
        ...
        if (CalculationUtils.isNotEmpty(downloadParamVmo.getIsMandatoryUpdate()) || !downloadRedisDao.hasDownloadKey(key)) {
            //下载适配器
